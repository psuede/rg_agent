...
export async function addTweetIfNotExists(tweet) {
  console.log(tweet)
  let params = [tweet.id, tweet.conversationId, tweet.likes, tweet.bookmarkCount, tweet.name,
    tweet.replies, tweet.retweets, tweet.text, tweet.userId, tweet.username, tweet.isQuoted,
    tweet.isReply, tweet.isRetweet, tweet.isPin, tweet.sensitiveContent, tweet.timestamp, tweet.html
  ];
